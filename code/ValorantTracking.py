...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.LeaderboardRefresh.setGeometry(QtCore.QRect(10, 60, 71, 21))
        font = QtGui.QFont()
        font.setPointSize(8)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.LeaderboardTitle.setText(
            _translate("ValorantTrackingbyNavisGames", "Valorant | Leaderboard"))
    ...
    def get_information(self):
        try:
            ...
            for x in lastRank:
                # if next act, continue the for loop.
                if x == "e5a3":
                    continue
                # else add in the previous_ranks list the Ranks, the Wins and the last games played.
                else:
                    try:
                    ...
                    # if player didnt play in this act, then say No Data
