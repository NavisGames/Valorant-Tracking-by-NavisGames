...
class Ui_ValorantTrackerByNavisGames(object):
    def setupUi(self, ValorantTrackerByNavisGames):
        try:
            ...
            ValorantTrackerByNavisGames.setWindowTitle("Valorant Tracking 2.1 By NavisGames")
            icon = QtGui.QIcon()
            ...
            for i, bundles in enumerate(current_Bundle):
                ...
                self.BundleLast.setText(f"Bundle remaining in Shop: {display_time(bundles.seconds_remaining, 3)}")
